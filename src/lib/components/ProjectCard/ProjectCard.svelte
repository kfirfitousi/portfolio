...
<article class="rounded-lg max-w-2xl" aria-label={title}>
    <h1 class="text-xl h-10 leading-10 text-center bg-rose-700 dark:bg-pink-900 text-zinc-100 rounded-t-lg">{title}</h1>
    <div class="flex flex-col sm:flex-row">
        ...
        <div class="flex flex-col justify-center w-full p-2 sm:w-1/2 bg-zinc-50 dark:bg-zinc-700 text-rose-700 dark:text-zinc-100 rounded-b-lg sm:rounded-bl-none">
