...
<article class="rounded-lg max-w-2xl" aria-label={title}>
    ...
    <div class="flex flex-col sm:flex-row">
        ...
        <div class="flex flex-col justify-center w-full p-2 sm:w-1/2 bg-rose-50 dark:bg-zinc-700 text-rose-700 dark:text-zinc-100 rounded-b-lg sm:rounded-bl-none">
